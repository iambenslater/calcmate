...
function calculate() {
  ...
  // Hero result
  html += '<div style="background:linear-gradient(135deg,#00205B,#003380);color:#fff;border-radius:12px;padding:24px;margin-bottom:20px;text-align:center;">';
  if (r.annualAmount < 1) {
  ...
  html += '<h3 style="margin:0 0 16px;font-size:1.1em;color:#00205B;">Step-by-Step Breakdown</h3>';

  // Step 1
  html += '<div style="margin-bottom:14px;">';
  html += '<div style="font-weight:600;color:#00205B;font-size:0.95em;">Step 1: Child Support Income</div>';
  ...
  // Step 2
  html += '<div style="margin-bottom:14px;">';
  html += '<div style="font-weight:600;color:#00205B;font-size:0.95em;">Step 2: Combined Child Support Income</div>';
  ...
  // Step 3
  html += '<div style="margin-bottom:14px;">';
  html += '<div style="font-weight:600;color:#00205B;font-size:0.95em;">Step 3: Income Percentages</div>';
  ...
  // Step 4
  html += '<div style="margin-bottom:14px;">';
  html += '<div style="font-weight:600;color:#00205B;font-size:0.95em;">Step 4: Care Percentages</div>';
  ...
  // Step 5
  html += '<div style="margin-bottom:14px;">';
  html += '<div style="font-weight:600;color:#00205B;font-size:0.95em;">Step 5: Cost Percentages</div>';
  ...
  // Step 6
  html += '<div style="margin-bottom:14px;">';
  html += '<div style="font-weight:600;color:#00205B;font-size:0.95em;">Step 6: Child Support Percentage</div>';
  ...
  // Step 7
  html += '<div style="margin-bottom:14px;">';
  html += '<div style="font-weight:600;color:#00205B;font-size:0.95em;">Step 7: Costs of Children</div>';
  ...
  html += '<div style="font-weight:600;color:#00205B;font-size:0.95em;">Step 8: Annual Child Support</div>';
